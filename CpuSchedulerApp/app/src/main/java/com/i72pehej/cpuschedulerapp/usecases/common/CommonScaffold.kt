...
fun CommonTopAppBar(
    ...
    TopAppBar(
        ...
        actions = {
            ...
            IconButton(onClick = { mostrarPopupOne.value = listaDeProcesosGlobal.isNotEmpty() }) { Icon(imageVector = Icons.Filled.Delete, contentDescription = "Boton de Eliminar un proceso") }

            // Llamada a la funcion para eliminar un proceso
            EliminarProcesoTabla(showDialog = mostrarPopupOne)

            // Icono para limpiar la tabla de procesos
            IconButton(onClick = { mostrarPopupAll.value = listaDeProcesosGlobal.isNotEmpty() }) { Icon(imageVector = Icons.Filled.DeleteSweep, contentDescription = "Boton de Limpiar Tabla") }
